...
|------|------------------------------|---------|----------------|
| 2026-06-25 | Registered a hook in gitignored settings.local.json while its script was only on a feature branch → dangling reference errored on every edit after switching to main | CLAUDE.md rule | CLAUDE.md › Development System › Adding a guard gotcha |
