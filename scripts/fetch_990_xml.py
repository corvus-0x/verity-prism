...
Usage:
    python scripts/fetch_990_xml.py --ein 824458479 --years 2018 2019 2020 2021 2022 2023
    python scripts/fetch_990_xml.py --ein 824458479  # defaults to 2018-2025
...
def main():
    ...
    parser.add_argument("--ein",   required=True, help="EIN without dashes, e.g. 824458479")
