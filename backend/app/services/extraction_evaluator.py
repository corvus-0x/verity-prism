...
def evaluate(
    ...
    for e in extractions:
        ...
        # Fields absent from the document (null/empty value) are not extraction
        # failures — they simply don't apply to this document. Evaluating their
        # confidence (which Claude returns as ~0.1 for "not found") would
        # incorrectly flag the document for human review.
        field_value = e.get("field_value")
