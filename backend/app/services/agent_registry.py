...
def build_tool_schemas() -> list[dict]:
    """Return the JSON schemas for all 7 core tools.
        ...
        },
        {
            ...
            "input_schema": {
                ...
                "properties": {
                    "connector_id": {
                        "type": "string",
                        "description": "e.g. 'irs-teos'",
                    },
                    "search_query": {
                        "type": "string",
                        "description": "Name/term to search, e.g. an org name",
                    },
                    "reason": {
                        "type": "string",
                        "description": "Why this source helps the investigation",
                    },
                },
