...
LEGAL = [
    ...
    {"name": "special_notice",           "type": "text",      "description": "Content of the Special Notice section if present (Madison County format)", "required": False},
]
...
DEED_PROPERTY = [
    ...
    {"name": "prior_deed_instrument_number", "type": "id_number", "description": "Instrument number of the prior deed (Madison County and other counties that use instrument numbers instead of book/page)", "required": False},
...
- book and page: the Official Records volume and page — may not appear in Madison County format
...
UCC_FILER = [
    ...
    {"name": "filer_org",     "type": "text",    "description": "Filing agent organization (e.g. Diligenz, Corporation Service Company, Example Lender) — repeated filer names across amendments confirm coordinated batch activity", "required": False},
...
Filer information:
  ...
  - Employee names in email addresses (e.g. brenda.keller@e-farmcredit.com) identify individuals
