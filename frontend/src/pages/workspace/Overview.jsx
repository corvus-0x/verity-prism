...
export default function Overview() {
  ...
  const statCards = [
    { label: 'Documents', value: stats.documents, color: 'text-blue-400', path: 'documents' },
    { label: 'Entities', value: stats.entities, color: 'text-purple-400', path: 'entities' },
    ...(workspace?.vertical === 'fraud'
      ? [{ label: 'Findings', value: stats.findings, color: 'text-red-400', path: 'findings' }]
      : []),
  ]
